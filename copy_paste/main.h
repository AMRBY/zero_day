...
va_list list, char BFR[], int flags, int width, int precision, int size);
...
char BFR[], int flags, char flag_ch, int width, int precision, int size);

/* Function to print non printable characters */
int prnt_n_printable(va_list types, char BFR[],
	int flags, int width, int precision, int size);
...
int apnd_hex_cod(char, char[], int);
int is_digit(char);

long int cnvrt_siz_number(long int num, int size);
long int cnvrt_siz_unsnumber(unsigned long int num, int size);
